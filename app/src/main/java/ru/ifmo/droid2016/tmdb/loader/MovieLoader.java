 ...
 */
public class MovieLoader extends android.support.v4.content.AsyncTaskLoader<LoadResult<List<Movie>>> {
    ...
    public LoadResult<List<Movie>> loadInBackground() {
        ...
        try {
            connection = TmdbApi.getPopularMoviesRequest(Locale.getDefault().getLanguage(),1);
