...
public class ConfigurationLoader extends AsyncTaskLoader<LoadResult<String>> {
    ...
    public LoadResult<String> loadInBackground() {
        ...
        try {
            connection = TmdbApi.getConfigurationRequest();
            ...
            if (connection.getResponseCode() == HttpURLConnection.HTTP_OK) {
                ...
                data = MoviesDomParser.parseBaseUrl(in);
